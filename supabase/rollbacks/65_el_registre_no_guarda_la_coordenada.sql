-- Rollback de la migració 65. NO és a `migrations/` a posta: un fitxer aquí
-- dins el desfaria el mateix `db push` que acaba d'aplicar-lo.
--
-- Torna `lat` i `lng` al `detall` de l'audit_log, o sigui que la junta torna a
-- tenir la coordenada exacta de cada fitxatge per ubicació durant 24 mesos.
--
